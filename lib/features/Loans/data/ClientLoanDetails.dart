...
//
//     final clientLoanDetails = clientLoanDetailsFromJson(jsonString);

import 'dart:convert';

ClientLoanDetails clientLoanDetailsFromJson(String str) => ClientLoanDetails.fromJson(json.decode(str));

String clientLoanDetailsToJson(ClientLoanDetails data) => json.encode(data.toJson());
...
class ClientLoanDetails {
    ...
    factory ClientLoanDetails.fromJson(Map<String, dynamic> json) => ClientLoanDetails(
        status: json["status"],
