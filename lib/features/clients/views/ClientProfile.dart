...
class ClientProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Ensure that if the profile is not fetched, we fetch it
    if (controller.clientProfile.value == null && controller.clientId.value != null) {
      controller.fetchClientProfile(controller.clientId.value!);
    }
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      if (controller.clientId.value != null) {
                        controller.fetchClientProfile(controller.clientId.value!);
                      }
                    },
